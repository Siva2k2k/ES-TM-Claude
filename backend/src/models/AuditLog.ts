...
const AuditLogSchema: Schema = new Schema(
  {
    ...
    action: {
      ...
      enum: [
        ...
        'USER_SOFT_DELETED', 'USER_HARD_DELETED', 'USER_RESTORED',
        'TIMESHEET_SUBMITTED', 'TIMESHEET_APPROVED', 'TIMESHEET_VERIFIED',
        'TIMESHEET_REJECTED', 'TIMESHEET_SOFT_DELETED', 'TIMESHEET_HARD_DELETED',
        'TIMESHEET_RESTORED', 'PROJECT_CREATED', 'PROJECT_UPDATED',
        'PROJECT_DELETED', 'BILLING_SNAPSHOT_GENERATED', 'BILLING_APPROVED',
        'REPORT_GENERATED', 'CUSTOM_REPORT_CREATED',
