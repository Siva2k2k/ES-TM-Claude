 ...
 * @access Private
 */
router.put('/profile', requireAuth, SettingsController.updateUserSettings);
 ...
 * @access Private
 */
router.put('/theme', requireAuth, SettingsController.updateTheme);
 ...
 * @access Private
 */
router.put('/notifications', requireAuth, SettingsController.updateNotifications);
