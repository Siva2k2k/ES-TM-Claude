...
// Dashboard Pages
import { RoleDashboardSelector } from './pages/dashboard/RoleDashboardSelector';
    ...
    <>
      <Routes>
        ...
        <Route path="/dashboard" element={
          ...
          {/* Dashboard Home - Role-specific dashboards */}
          <Route index element={<RoleDashboardSelector />} />
